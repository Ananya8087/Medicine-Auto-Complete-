...
fetch(chrome.runtime.getURL('medicines.json'))
    ...
    .then(medicines => {
        ...
        document.addEventListener('input', function(event) {
            ...
            if (inputField.matches('input.p-inputtext.p-component.p-filled.p-inputtext-sm')) {
        ...
        document.addEventListener('click', function(event) {
            ...
            const isInputField = target.matches('input.p-inputtext.p-component.p-filled.p-inputtext-sm');
